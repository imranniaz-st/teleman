var FullCalendar = function (e) {
    ...
    L.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : L.FullCalendarVDom = {
        ...
        flushToDom: function () {
            ...
            for (i.debounceRendering = function (e) {
                    t.push(e)
                }, U(g(W, {}), document.createElement("div")); t.length;) t.shift()();
        ...
        gt = function () {
            ...
            return e.prototype.format = function (e, t) {
                ...
                var o = this.standardDateProps,
                    ...
                    a = function (e, t, n) {
                        return n.getMarkerYear(e) !== n.getMarkerYear(t) ? 5 : n.getMarkerMonth(e) !== n.getMarkerMonth(t) ? 4 : n.getMarkerDay(e) !== n.getMarkerDay(t) ? 2 : Pe(e) !== Pe(t) ? 1 : 0
        ...
        return 1 === o && "short" === e.timeZoneName ? function (e) {
            ...
            return function (r) {
                ...
                return function (e, t, n, r, o) {
                    return e = e.replace(ht, ""), "short" === n.timeZoneName && (e = function (e, t) {
                        var n = !1;
                        return e = e.replace(vt, (function () {
                            return n = !0, t
                        })), n || (e += " " + t), e
                    }(e, "UTC" === o.timeZone || null == t.timeZoneOffset ? "UTC" : it(t.timeZoneOffset))), r.omitCommas && (e = e.replace(pt, "").trim()), r.omitZeroMinute && (e = e.replace(":00", "")), !1 === r.meridiem ? e = e.replace(dt, "").trim() : "narrow" === r.meridiem ? e = e.replace(dt, (function (e, t) {
    ...
    function Yt(e, t, n, r, o) {
        ...
        if (u) return (c = Kt(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
            typeId: u.typeId,
            typeData: u.typeData,
            duration: u.duration
        }, {
    ...
    function Zt(e, t, n) {
        return void 0 === n && (n = Xt(t)), It(e, n)
    }

    function Xt(e) {
        return r(r(r({}, Wt), qt), e.pluginHooks.eventRefiners)
    }

    function Kt(e, t, n, o, i, a) {
        for (var s = {
                title: e.title || "",
                groupId: e.groupId || "",
                publicId: e.id || "",
    ...
    function tn(e, t) {
        var n, r, o = [],
            i = t.start;
        for (e.sort(nn), n = 0; n < e.length; n += 1)(r = e[n]).start > i && o.push({
            start: i,
            end: r.start
        }), r.end > i && (i = r.end);
    ...
    function un(e, t, n, r) {
        ...
        for (var m in o)
            for (var y = 0, E = tn(o[m], n); y < E.length; y++) {
                var S, D = E[y];
        ...
        for (var c in i)
            for (var b = 0, C = tn(i[c], n); b < C.length; b++) D = C[b], s.push({
                def: e.defs[c],
                ui: u[c],
                instance: null,
                range: D,
    ...
    function Tn(e, t) {
        return on(e.range, t.range) && e.allDay === t.allDay && function (e, t) {
            for (var n in t)
    ...
    function In(e, t) {
        ...
        return r(i, (n = e, o = t.dateEnv, r(r({}, Mn(n.range, o, n.allDay)), {
            allDay: n.allDay
        }))), i
    }
    ...
    function Nn(e, t, n, r) {
        ...
        for (var l in e.instances) {
            var u = e.instances[l];
            s = i.defs[u.defId], i.instances[l] = On(u, s, o[u.defId], n, r)
        }
        return i
    }
    ...
    function On(e, t, n, o, i) {
        var a = i.dateEnv,
            ...
            u = r({}, e);
        return s && (u.range = Jt(u.range)), o.datesDelta && n.startEditable && (u.range = {
    ...
    function Wn(e) {
        return r(r(r({}, Wt), Un), e.pluginHooks.eventSourceRefiners)
    }
    ...
    var Fn = function () {
        ...
        zn = function () {
            ...
            return e.prototype.setProp = function (e, t) {
                var n, r;
                if (e in Gt) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead.");
                else if (e in jt) t = jt[e](t), this.mutate({
                ...
                var n = this._context.dateEnv,
                    r = n.createMarker(e);
                if (r && this._instance) {
                    var o = en(this._instance.range.start, r, n, t.granularity);
                ...
                if ((null == e || (n = r.createMarker(e))) && this._instance)
                    if (n) {
                        var o = en(this._instance.range.end, n, r, t.granularity);
                        this.mutate({
                            endDelta: o
                        })
                    } else this.mutate({
                ...
                if (l && (null == t || (r = a.createMarker(t))) && this._instance) {
                    ...
                    !0 === n.allDay && (u = Jt(u));
                    var c = en(u.start, l, a, n.granularity);
                    if (r) {
                        var d = en(u.end, r, a, n.granularity);
        ...
        pr = function () {
            ...
            return e.prototype.splitProps = function (e) {
                ...
                for (var c in this.eventUiBuilders = Ue(n, (function (e, n) {
                        return t.eventUiBuilders[n] || st(fr)
                    })), n) {
                    var d = n[c],
                        p = a[c] || dr,
    ...
    var Nr = FullCalendarVDom.Component,
        ...
        Vr = FullCalendarVDom.unmountComponentAtNode,
        Fr = function () {
            function e(e, t, n) {
                var o = this;
    ...
    function Br(e, t, n, r, o, i, a, s, l, u, c, d, p) {
        return {
            dateEnv: o,
            options: n,
            pluginHooks: a,
            ...
            createScrollResponder: function (e) {
                return new Fr(e, u, Xe(n.scrollTime))
            },
    ...
    var jr = function (e) {
        ...
        }, t.addPropsEquality = qr, t.addStateEquality = Yr, t.contextType = zr, t
    }(Nr);
    ...
    function Qr(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && ! function (e, t, n, o) {
            var i = t.getCurrentData(),
                ...
                l = s.defs,
                u = s.instances,
                c = fn(l, a.isEvent ? e.eventUiBases : {
                    "": i.selectionConfig
                });
            o && (c = Ue(c, o));
            var d, p, f = (d = e.eventStore, p = a.affectedEvents.instances, {
                    defs: d.defs,
                    instances: Ae(d.instances, (function (e) {
                        return !p[e.instanceId]
                    }))
                }),
                h = f.defs,
                v = f.instances,
                g = fn(h, e.eventUiBases);
            for (var m in u) {
                var y = u[m],
                    E = y.range,
                    S = c[y.defId],
                    D = l[y.defId];
                if (!eo(S.constraints, E, f, e.businessHours, t)) return !1;
                ...
                for (var w in v) {
                    ...
                    if (an(E, R.range)) {
                        ...
                        if (C && !C(new zn(t, h[R.defId], R), new zn(t, D, y))) return !1
                    }
                }
                for (var T = i.eventStore, k = 0, M = S.allows; k < M.length; k++) {
                    var x, _ = M[k],
                        ...
                        P = T.defs[D.defId],
                        N = T.instances[m];
                    if (x = P ? new zn(t, P, N) : new zn(t, D), !_(In(I, t), x)) return !1
                }
            }
            return !0
            ...
            if (o && (c = o(c)), !eo(c.constraints, u, i, e.businessHours, t)) return !1;
            ...
            for (var v = 0, g = c.allows; v < g.length; v++) {
                if (!(0, g[v])(In(r(r({}, n), l), t), null)) return !1
            }
            return !0
        }(e, t, n, o))
    }
    ...
    function to(e, t, n, r, o) {
        return "businessHours" === e ? no(Ge(r, t, o)) : "string" == typeof e ? no(Ut(n, (function (t) {
            return t.groupId === e
        }))) : "object" == typeof e && e ? no(Ge(e, t, o)) : []
    }
    ...
    var oo = function (e) {
        ...
        return n(t, e), t.prototype.prepareHits = function () {}, t.prototype.queryHit = function (e, t, n, r) {
            ...
            if (t)
                for (var r in n)
                    if (!sn(t.validRange, n[r].range)) return !1;
            return Jr(e, this.context)
        }, t.prototype.isDateSelectionValid = function (e) {
            var t = this.props.dateProfile;
            return !(t && !sn(t.validRange, e.range)) && $r({
                dateSelection: e
            }, this.context)
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                return Hr(fo, {
                    ...
                    return Hr(co, {
                        ...
                        return t.children(r, vo(t.classNames, n), e, o)
                    }))
                }))
            }, t
        }(Gr),
    ...
    function co(e) {
        return Hr(uo.Consumer, null, (function (t) {
            return Hr(po, r({
                renderId: t
            }, e))
        }))
    ...
    function ho() {
        var e, t, n = [];
        return function (r, o) {
            return t && Ve(t, o) && r === e || (e = r, t = o, n = vo(r, o)), n
        }
    }

    function vo(e, t) {
        return "function" == typeof e && (e = e(t)), Lt(e)
    }
            ...
            return function (e, t, n, o, i) {
                ...
                if (a && (s = function (e) {
                        var t = JSON.stringify(e),
                            n = Do[t];
                        return void 0 === n && (n = Xe(e), Do[t] = n), n
                    }(a))) {
                    var d = nt(s);
    ...
    var Do = {},
        bo = function () {
            ...
            return e.prototype.buildPrev = function (e, t, n) {
                ...
                return r = this.buildValidRange(), r = this.trimHiddenDays(r), n && (u = e, e = null != (c = r).start && u < c.start ? c.start : null != c.end && u >= c.end ? new Date(c.end.valueOf() - 1) : u), o = this.buildCurrentRangeInfo(e, t), i = /^(year|month|week|day)$/.test(o.unit), a = this.buildRenderRange(this.trimHiddenDays(o.range), o.unit, i), s = a = this.trimHiddenDays(a), d.showNonCurrentDates || (s = rn(s, o.range)), s = rn(s = this.adjustActiveRange(s), r), l = an(o.range, r), {
                    validRange: r,
    ...
    function wo(e, t, n, o) {
        ...
        return n && (i = Ro(i, n, o)), r(r({}, e), i)
    }

    function Ro(e, t, n) {
        return To(e, Ae(e, (function (e) {
            return function (e, t, n) {
                return xo(e, n) ? !n.options.lazyFetching || !e.fetchRange || e.isFetching || t.start < e.fetchRange.start || t.end > e.fetchRange.end : !e.latestFetchId
            }(e, t, n)
        })), t, n)
    }
    ...
    function Ho(e, t, n, r, o) {
        var i = [];
        return {
            headerToolbar: e.headerToolbar ? Oo(e.headerToolbar, e, t, n, r, o, i) : null,
            footerToolbar: e.footerToolbar ? Oo(e.footerToolbar, e, t, n, r, o, i) : null,
            viewsWithButtons: i
        }
    }
    ...
    var Wo = [io({
        ...
        eventSourceDefs: [{
            ...
            fetch: function (e, t, n) {
                ...
                Tr(e.eventSource.meta.bind(null, kn(e.range, r)), (function (e) {
                    t({
                        rawEvents: e
                    })
                }), n)
        ...
        eventSourceDefs: [{
            ...
            fetch: function (e, t, n) {
                ...
                Ao(o.method, o.url, i, (function (e, n) {
                    t({
                        rawEvents: e,
                        xhr: n
                    })
        ...
        propSetHandlers: {
            dateProfile: function (e, t) {
                t.emitter.trigger("datesSet", r(r({}, kn(e.activeRange, t.dateEnv)), {
                    view: t.viewApi
                }))
            },
    ...
    var Go = function () {
        function e(e) {
            var t = this;
            this.computeOptionsData = st(this._computeOptionsData), this.computeCurrentViewData = st(this._computeCurrentViewData), this.organizeRawLocales = st($n), this.buildLocale = st(Qn), this.buildPluginHooks = function () {
                var e, t = [],
                    n = [];
                return function (o, i) {
            ...
            var s, l, u, c = (s = o.calendarOptions, l = o.dateEnv, null != (u = s.initialDate) ? l.createMarker(u) : Vn(s.now, l)),
                d = a.dateProfileGenerator.build(c);
            ln(d.activeRange, c) || (c = d.currentRange.start);
            for (var p = {
                    dateEnv: o.dateEnv,
            ...
            Qo(g, p) && this.emitter.trigger("loading", !0), this.state = g, this.updateData(), this.actionRunner.resume()
        }
        return e.prototype.resetOptions = function (e, t) {
            ...
            this.data && this.data.dateProfileGenerator !== l.dateProfileGenerator && (d = l.dateProfileGenerator.build(c)), d = function (e, t, n, r) {
                ...
                switch (t.type) {
                    ...
                    case "CHANGE_DATE":
                        if (!e.activeRange || !ln(e.currentRange, t.dateMarker)) return r.build(t.dateMarker);
                        break;
                    case "PREV":
            ...
            }(c, e), l.dateProfileGenerator), ln(d.currentRange, c) || (c = d.currentRange.start);
            for (var p = function (e, t, n, o) {
                    var i, a, s = n ? n.activeRange : null;
                    switch (t.type) {
                        case "ADD_EVENT_SOURCES":
                            return wo(e, t.sources, s, o);
                        ...
                        case "FETCH_EVENT_SOURCES":
                            return To(e, t.sourceIds ? Le(t.sourceIds) : Mo(e, o), s, o);
                        case "RECEIVE_EVENTS":
                ...
                }(n.eventSources, e, d, u), f = function (e, t, n, r, o) {
                    switch (t.type) {
                        case "RECEIVE_EVENTS":
                            return function (e, t, n, r, o, i) {
                                if (t && n === t.latestFetchId) {
                                    var a = Nt(function (e, t, n) {
                                        ...
                                        return o && (e = Xr(e, o)), r && (e = Xr(e, r)), e
                                    }(o, t, i), t, i);
                                    return r && (a = Ge(a, r, i)), At(Kr(e, t.sourceId), a)
                                }
                                return e
                            }(e, n[t.sourceId], t.fetchId, t.fetchRange, t.rawEvents, o);
                        case "ADD_EVENTS":
                            return function (e, t, n, r) {
                                return n && (t = Ge(t, n, r)), At(e, t)
                            }(e, t.eventStore, r ? r.activeRange : null, o);
                        case "RESET_EVENTS":
                            return t.eventStore;
                        case "MERGE_EVENTS":
                            return At(e, t.eventStore);
                        case "PREV":
                        case "NEXT":
                        case "CHANGE_DATE":
                        case "CHANGE_VIEW_TYPE":
                ...
                }(n.eventStore, e, p, d, u), h = Co(p) && !l.options.progressiveEventRendering && n.renderableEventStore || f, v = this.buildViewUiProps(u), g = v.eventUiSingleBase, m = v.selectionConfig, y = this.buildEventUiBySource(p), E = {
                    ...
                    dateSelection: _o(n.dateSelection, e),
                    eventSelection: Io(n.eventSelection, e),
                    eventDrag: Po(n.eventDrag, e),
                    eventResize: No(n.eventResize, e)
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props,
                ...
                y = f.calendarOptions;
            if (m && m !== y)
                for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, l = v, u = (s = d.dateProfile) ? s.activeRange : null, To(a, Mo(a, l), u, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = Ue(e.instances, (function (e) {
                        var i = o[e.defId];
            ...
            var n = _t([wt, e, t]),
                ...
                u = this.buildPluginHooks(e.plugins || [], Wo),
    ...
    function Zo(e) {
        return new(e.dateProfileGeneratorClass || bo)(e)
    }
    ...
    var di = function (e) {
        ...
        vi = function (e) {
            function t(t) {
                ...
                return a.handleEventElRemove = function (e) {
                    ...
                    pn(t) && (a.currentSegEl = t, a.triggerEvent("eventMouseEnter", e, t))
                }, a.handleSegLeave = function (e, t) {
                    a.currentSegEl && (a.currentSegEl = null, a.triggerEvent("eventMouseLeave", e, t))
                }, a.removeHoverListeners = (n = t.el, ".fc-event", r = a.handleSegEnter, o = a.handleSegLeave, K(n, "mouseover", ".fc-event", (function (e, t) {
                    if (t !== i) {
                        i = t, r(e, t);
                        var n = function (e) {
        ...
        gi = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildViewContext = st(Br), t.buildViewPropTransformers = st(yi), t.buildToolbarProps = st(mi), t.handleNavLinkClick = X("a[data-navlink]", t._handleNavLinkClick.bind(t)), t.headerRef = Ar(), t.footerRef = Ar(), t.interactionsStore = {}, t.registerInteractiveComponent = function (e, n) {
                    var r = oi(e, n),
                        o = [hi, vi].concat(t.props.pluginHooks.componentInteractions).map((function (e) {
                            return new e(r)
                        }));
                    t.interactionsStore[e.uid] = o, ai[e.uid] = r
                }, t.unregisterInteractiveComponent = function (e) {
                    for (var n = 0, r = t.interactionsStore[e.uid]; n < r.length; n++) r[n].destroy();
                    delete t.interactionsStore[e.uid], delete ai[e.uid]
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                }, this.renderView(t), this.buildAppendContent()), n.footerToolbar && Hr(pi, r({
                    ref: this.footerRef,
    ...
    function mi(e, t, n, r, o, i) {
        ...
        return {
            title: i,
            activeButton: e.type,
            isTodayEnabled: a.isValid && !ln(t.currentRange, o),
        ...
        wi = function (e) {
            ...
            return n(t, e), t.prototype.render = function () {
                var e = this.props,
                    ...
                    u = [Di].concat(vr(l, o), e.extraClassNames || []),
    ...
    var ki = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.createDayHeaderFormatter = st(Mi), t
        }
        return n(t, e), t.prototype.render = function () {
            var e = this.context,
                t = this.props,
            ...
            return Hr(Ri, {
                ...
                return Hr("tr", null, i && i("day"), n.map((function (e) {
                    return o ? Hr(Ci, {
                        key: e.toISOString(),
                        date: e,
                        dateProfile: r,
    ...
    var xi = function () {
        ...
        Ii = function () {
            ...
            return e.prototype.sliceProps = function (e, t, n, r) {
                ...
                for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a];
                return e ? this._sliceEventStore.apply(this, o([Ge(e, Pi(t, Boolean(n)), r), {}, t, n], i)).bg : []
            }, e.prototype._sliceEventStore = function (e, t, n, r) {
                for (var o = [], i = 4; i < arguments.length; i++) o[i - 4] = arguments[i];
                if (e) {
                    var a = un(e, t, Pi(n, Boolean(r)), r);
                    return {
                ...
                for (var o = [], i = 4; i < arguments.length; i++) o[i - 4] = arguments[i];
                if (!e) return null;
                var a = un(e.mutatedEvents, t, Pi(n, Boolean(r)), r);
                return {
                ...
                if (!e) return [];
                for (var a = xn(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s; l < u.length; l++) {
                    var c = u[l];
                    c.eventRange = a
                }
                return s
    ...
    var Ni = /^(visible|hidden)$/,
        Hi = function (e) {
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                if (Ni.test(this.props.overflowX)) return !1;
                ...
                if (Ni.test(this.props.overflowY)) return !1;
                ...
                return Ni.test(this.props.overflowX) ? 0 : this.el.offsetHeight - this.el.clientHeight
            }, t.prototype.getYScrollbarWidth = function () {
                return Ni.test(this.props.overflowY) ? 0 : this.el.offsetWidth - this.el.clientWidth
            }, t
        }(Gr),
        Oi = function () {
            function e(e) {
    ...
    function Fi(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(Hr("col", {
                style: {
    ...
    var Xi = function (e) {
        function t() {
            ...
            return t.processCols = st((function (e) {
                return e
            }), Vi), t.renderMicroColGroup = st(Fi), t.scrollerRefs = new Oi, t.scrollerElRefs = new Oi(t._handleScrollerEl.bind(t)), t.state = {
                shrinkWidth: null,
                forceYScrollbars: !1,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return "outerContent" in e ? Hr(Ur, {
                ...
                key: e.key,
                className: Gi(e, this.props.liquid).join(" ")
            ...
            return Bi(this.props.cols) ? Ai(this.scrollerElRefs.getAll()) : 0
            ...
            return n(t, e), t.prototype.render = function () {
                var e = this.props,
                    ...
                    a = {
                        ...
                        isDraggable: !e.disableDragging && mn(r, t),
                        isStartResizable: !e.disableResizing && yn(r, t),
                        isEndResizable: !e.disableResizing && En(r),
                ...
                dn(this.elRef.current, this.props.seg)
            }, t.prototype.componentDidUpdate = function (e) {
                var t = this.props.seg;
                t !== e.seg && dn(this.elRef.current, t)
            }, t
        }(Gr),
        Ji = function (e) {
            function t() {
            ...
            return n(t, e), t.prototype.render = function () {
                var e = this.props,
                    ...
                    i = Sn(n, o, t, e.defaultDisplayEventTime, e.defaultDisplayEventEnd);
                return Hr(Ki, {
                    seg: n,
                    timeText: i,
                    disableDragging: e.disableDragging,
                    disableResizing: e.disableResizing,
                    defaultContent: e.defaultContent || $i,
    ...
    function na(e) {
        ...
        return r(r(r({
            ...
            dayNumberText: e.showDayNumber ? n.format(t, ea) : ""
        }), e.extraProps)
    }
    var ra = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.refineHookProps = lt(na), t.normalizeClassNames = ho(), t
        }
        return n(t, e), t.prototype.render = function () {
            var e = this.props,
                t = this.context,
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function (e) {
                ...
                if (o.isRendering) {
                    ...
                    Or(Hr(Ei, {
                        ...
                        return o.setClassNames(t), o.setHeight(n), Hr(uo.Provider, {
                ...
                } else o.isRendered && (o.isRendered = !1, Vr(o.el), o.setClassNames([]), o.setHeight(""));
                Wr()
            }, o.el = t, o.renderRunner = new zo(o.handleRenderRequest), new Go({
                optionOverrides: n,
                calendarApi: o,
        ...
        fa = function () {
            function e(e) {
                ...
                this.subjectEl = null, this.selector = "", this.handleSelector = "", this.shouldIgnoreMove = !1, this.shouldWatchScroll = !0, this.isDragging = !1, this.isTouchDragging = !1, this.wasTouchScroll = !1, this.handleMouseDown = function (e) {
                    ...
                    passive: !0
                }), 1 === (da += 1) && window.addEventListener("touchmove", ha, {
                    passive: !1
                })
            }
            return e.prototype.destroy = function () {
                this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {
                    passive: !0
                }), (da -= 1) || window.removeEventListener("touchmove", ha, {
                    passive: !1
                })
    ...
    var va = function () {
        ...
        Sa = function () {
            ...
            return e.prototype.start = function (e, t) {
                ...
                return this.queryScrollEls().map((function (e) {
                    return e === window ? new ya(!1) : new ma(e, !1)
                }))
        ...
        Da = function (e) {
            function t(t, n) {
                ...
                var o = r.pointer = new fa(t);
                return o.emitter.on("pointerdown", r.onPointerDown), o.emitter.on("pointermove", r.onPointerMove), o.emitter.on("pointerup", r.onPointerUp), n && (o.selector = n), r.mirror = new va, r.autoScroller = new Sa, r
            }
            return n(t, e), t.prototype.destroy = function () {
        ...
        ba = function () {
            ...
            return e.prototype.destroy = function () {
                ...
                for (var n, r = {
                    ...
                    var a = i[o];
                    if (void 0, "HTML" !== (n = a.getEventTarget().tagName) && "BODY" !== n && !ir(r, a.clientRect)) return !1
                }
                return !0
            }, e
        }(),
        Ca = function () {
            ...
            return e.prototype.processFirstCoord = function (e) {
                ...
                this.offsetTrackers = Ue(this.droppableStore, (function (e) {
                    return e.component.prepareHits(), new ba(e.el)
                }))
                ...
                for (var i in n) {
                    ...
                    if (s && s.isWithinClipping(e, t)) {
                        ...
                        if (c >= 0 && c < f && d >= 0 && d < h) {
                            ...
                            v && sn(g.activeRange, v.dateSpan.range) && (!o || v.layer > o.layer) && (v.rect.left += l, v.rect.right += l, v.rect.top += u, v.rect.bottom += u, o = v)
                        }
                    }
                }
                return o
    ...
    function wa(e, t) {
        return !e && !t || Boolean(e) === Boolean(t) && Tn(e.dateSpan, t.dateSpan)
    }
    ...
    var Ta = function (e) {
            function t(t) {
                ...
                }, n.dragging = new Da(t.el), n.dragging.autoScroller.isEnabled = !1;
                var o = n.hitDragging = new Ca(n.dragging, ii(t));
        ...
        Ma = function (e) {
            function t(n) {
                ...
                o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                    ...
                    var u = o.subjectSeg = pn(e.subjectEl),
                    ...
                    if (o.isDragging) {
                        ...
                        if (e) {
                            ...
                            i === a || p.editable && p.droppable ? (s = function (e, t, n) {
                                ...
                                var l = en(i, a, e.component.context.dateEnv, e.component === t.component ? e.component.largeUnit : null);
                        ...
                        o.displayDrag(a, c), u ? te() : ne(), t || (i === a && wa(r, e) && (s = null), o.dragging.setMirrorNeedsRevert(!s), o.dragging.setMirrorIsVisible(!e || !document.querySelector(".fc-event-mirror")), o.receivingContext = a, o.validMutation = s, o.mutatedRelevantEvents = l)
                    }
                    ...
                    if (o.isDragging) {
                        ...
                        if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
                            ...
                            if (a === t) {
                                ...
                                }), a.emitter.trigger("drop", r(r({}, Ra(f.dateSpan, a)), {
                                    draggedEl: e.subjectEl,
                                    jsEvent: e.origEvent,
        ...
        xa = function (e) {
            function t(t) {
                ...
                n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                    ...
                    n.draggingSegEl = o, n.draggingSeg = pn(o), t.calendarApi.unselect(), t.emitter.trigger("eventResizeStart", {
                        el: o,
                    ...
                    e && (u = function (e, t, n, o, i) {
                        for (var a = e.component.context.dateEnv, s = en(e.dateSpan.range.start, t.dateSpan.range.start, a, e.component.largeUnit), l = {}, u = 0, c = i; u < c.length; u++) {
                            var d = (0, c[u])(e, t);
                            if (!1 === d) return null;
                            d && r(l, d)
                        }
                    ...
                    }), d ? te() : ne(), t || (u && wa(s, e) && (u = null), n.validMutation = u, n.mutatedRelevantEvents = c)
                }, n.handleDragEnd = function (e) {
                    var t = n.component.context,
                        o = n.eventRange.def,
            ...
            function e(e) {
                ...
                this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = function (e) {
                    ...
                    var n = t.context.options.unselectCancel,
                        r = e.origEvent.target;
                    t.matchesCancel = !!z(r, n), t.matchesEvent = !!z(r, Ma.SELECTOR)
                ...
                var n = this.documentPointer = new fa(document);
        ...
        Na = function () {
            function e(e, t) {
                ...
                this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                    ...
                    e && (a = e.component.context, n.canDropElOnCalendar(o.subjectEl, a) && (s = function (e, t, n) {
                        ...
                        var l = Zt(o, n),
                            u = Kt(l.refined, l.extra, t.sourceId, e.allDay, n.options.forceEventDuration || Boolean(t.duration), n),
                            c = e.range.start;
                        e.allDay && t.startTime && (c = n.dateEnv.add(c, t.startTime));
                        var d = t.duration ? n.dateEnv.add(c, t.duration) : Pn(e.allDay, c, n);
                        return {
                            def: u,
                            instance: Ne(u.defId, {
                                start: c,
                    ...
                    }(e.dateSpan, n.dragMeta, a), u.mutatedEvents = Ht(s), (l = !Jr(u, a)) && (u.mutatedEvents = {
                        defs: {},
                        instances: {}
                    ...
                    if (n.clearDrag(), o && i) {
                        var a = n.hitDragging.finalHit,
                            ...
                            l = n.dragMeta;
                        if (o.emitter.trigger("drop", r(r({}, Ra(a.dateSpan, o)), {
                                draggedEl: e.subjectEl,
                                jsEvent: e.origEvent,
                                view: s
                            })), l.create) {
                ...
                var o = this.hitDragging = new Ca(e, ai);
            ...
            return e.prototype.buildDragMeta = function (e) {
                return "object" == typeof this.suppliedDragMeta ? ci(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? ci(this.suppliedDragMeta(e)) : ci((t = function (e, t) {
    ...
    var Ha = function () {
            function e(e, t) {
                ...
                var r = this.dragging = new Da(e);
                r.touchScrollAllowed = !1, null != t.itemSelector && (r.pointer.selector = t.itemSelector), null != t.appendTo && (r.mirror.parentNode = t.appendTo), r.emitter.on("pointerdown", this.handlePointerDown), r.emitter.on("dragstart", this.handleDragStart), new Na(r, t.eventData)
            }
            return e.prototype.destroy = function () {
                this.dragging.destroy()
            }, e
        ...
        Aa = function () {
            function e(e, t) {
                ...
                "string" == typeof t.itemSelector ? r.pointer.selector = t.itemSelector : n === document && (r.pointer.selector = "[data-event]"), "string" == typeof t.mirrorSelector && (r.mirrorSelector = t.mirrorSelector), new Na(r, t.eventData)
            }
            return e.prototype.destroy = function () {
                this.dragging.destroy()
            }, e
        ...
        Ua = io({
            componentInteractions: [Ta, ka, Ma, xa],
            calendarInteractions: [_a],
            elementDraggingImpl: Da,
            optionRefiners: Ia,
            listenerRefiners: Pa
        }),
        La = function (e) {
    ...
    var Xa = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props,
                t = this.context,
                n = t.options.eventTimeFormat || Ya,
                o = Sn(e.seg, n, t, !0, e.defaultDisplayEventEnd);
            return Hr(Ki, {
                seg: e.seg,
                timeText: o,
                defaultContent: Ka,
    ...
    var es = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.cellElRefs = new Oi, t.frameElRefs = new Oi, t.fgElRefs = new Oi, t.segHarnessRefs = new Oi, t.rootElRef = Ar(), t.state = {
                framePositions: null,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this,
                ...
                o = this.context,
                i = t.cells.length,
                a = Va(t.businessHourSegs, i),
                s = Va(t.bgEventSegs, i),
                l = Va(this.getHighlightSegs(), i),
                u = Va(this.getMirrorSegs(), i),
                c = function (e, t, n, o, i, a, s, l) {
                    for (var u = [], c = [], d = {}, p = {}, f = {}, h = {}, v = {}, g = 0; g < s; g += 1) u.push([]), c.push(0);
                    for (var m = 0, y = t = vn(t, l); m < y.length; m++) T(w = y[m], i[w.eventRange.instance.instanceId + ":" + w.firstCol] || 0);
                    !0 === n || !0 === o ? function (e, t, n, r) {
                        Qa(e, t, n, !0, (function (e) {
                            return e.bottom <= r
                        }))
                    }(c, d, u, a) : "number" == typeof n ? function (e, t, n, r) {
                        Qa(e, t, n, !1, (function (e, t) {
                            return t < r
                        }))
                    }(c, d, u, n) : "number" == typeof o && function (e, t, n, r) {
                        Qa(e, t, n, !0, (function (e, t) {
                            return t < r
                        }))
                    }(c, d, u, o);
                    for (var E = 0; E < s; E += 1) {
                ...
                }(t.cells, t.fgEventSegs, t.dayMaxEvents, t.dayMaxEventRows, n.segHeights, n.maxContentHeight, i, o.options.eventOrder),
                d = c.paddingBottoms,
                p = c.segsByFirstCol,
                f = c.segsByEachCol,
                h = c.segIsHidden,
            ...
            return Hr("tr", {
                ...
                return Hr(Ga, {
                    ...
                    fgContent: Hr(Ur, null, Hr(Ur, null, i), Hr(Ur, null, c)),
                    bgContent: Hr(Ur, null, e.renderFillSegs(l[o], "highlight"), e.renderFillSegs(a[o], "non-business"), e.renderFillSegs(s[o], "bg-event"))
                })
            })))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing(!0)
    ...
    var ts = function (e) {
        ...
        rs = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.splitBusinessHourSegs = st(Wa), t.splitBgEventSegs = st(Wa), t.splitFgEventSegs = st(Wa), t.splitDateSelectionSegs = st(Wa), t.splitEventDrag = st(Fa), t.splitEventResize = st(Fa), t.buildBuildMoreLinkText = st(os), t.morePopoverRef = Ar(), t.rowRefs = new Oi, t.state = {
            ...
            return n(t, e), t.prototype.render = function () {
                var e = this,
                    ...
                    g = !0 === i || !0 === o;
                return g && !a && (g = !1, o = null, i = null), Hr("div", {
                    ...
                    }, t.colGroupNode, Hr("tbody", null, t.cells.map((function (a, s) {
                        return Hr(es, {
                    ...
                    })))), !t.forPrint && s && s.currentFgEventSegs === t.fgEventSegs && Hr(ns, {
    ...
    var as = function (e) {
        ...
        ss = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.slicer = new as, t.tableRef = Ar(), t.handleRootEl = function (e) {
        ...
        ls = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildDayTableModel = st(us), t.headerRef = Ar(), t.tableRef = Ar(), t
            }
            return n(t, e), t.prototype.render = function () {
                var e = this,
                    t = this.context,
    ...
    function us(e, t) {
        var n = new xi(e.renderRange, t);
        return new _i(n, /year|month|week/.test(e.currentRangeUnit))
    }
    var cs = io({
                    ...
                    dateProfileGeneratorClass: function (e) {
                        ...
                        return n(t, e), t.prototype.buildRenderRange = function (t, n, r) {
                            var o, i = this.props.dateEnv,
                                ...
                                s = a.start,
                                l = a.end;
                            return /^(year|month)$/.test(n) && (s = i.startOfWeek(s), (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = ge(o, 1))), this.props.monthMode && this.props.fixedWeekCount && (l = ge(l, 6 - Math.ceil(Ee(s, l)))), {
                                start: s,
                                end: l
                            }
                        }, t
        ...
        ds = function (e) {
            ...
            return n(t, e), t.prototype.getKeyInfo = function () {
                ...
                return e.allDay ? cn(e) ? ["timed", "allDay"] : ["allDay"] : ["timed"]
            }, t
        }(pr),
        ps = bt({
            hour: "numeric",
    ...
    function fs(e) {
        ...
        return Hr(zr.Consumer, null, (function (n) {
            ...
            var r = n.dateEnv,
                o = n.options,
                i = n.viewApi,
                a = null == o.slotLabelFormat ? ps : Array.isArray(o.slotLabelFormat) ? bt(o.slotLabelFormat[0]) : bt(o.slotLabelFormat),
                s = {
                    level: 0,
                    time: e.time,
    ...
    var vs = function (e) {
        ...
        ms = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.allDaySplitter = new ds, t.headerElRef = Ar(), t.rootElRef = Ar(), t.scrollerElRef = Ar(), t.state = {
                    slatCoords: null
                    ...
                    var o = t.context.options,
                        ...
                        a = Se(i.start, i.end),
                        s = o.navLinks && 1 === a ? {
                            "data-navlink": gr(i.start, "week"),
                            tabIndex: 0
                        } : {};
                    return o.weekNumbers && "day" === e ? Hr(sa, {
                        date: i.start,
                        defaultFormat: gs
                    }, (function (e, t, o, i) {
                        return Hr("th", {
            ...
            return n(t, e), t.prototype.renderSimpleLayout = function (e, t, n) {
                ...
                var u = this.context,
                    c = this.props,
                    d = !c.forPrint && Yi(u.options),
                    p = !c.forPrint && Zi(u.options),
                    f = [];
                e && f.push({
                    type: "header",
                    key: "header",
                    ...
                    chunks: [{
                        ...
                        rowContent: function (e) {
                            return Hr("tr", null, s.renderHeadAxis("day", e.rowSyncHeights[0]))
                        }
                    }, {
                        key: "cols",
                        elRef: this.headerElRef,
                ...
                return f.push({
                    ...
                    chunks: [{
                        ...
                        content: function (e) {
                            ...
                            }, e.tableColGroupNode, Hr("tbody", null, Hr(vs, {
                                slatMetas: i
                            }))), Hr("div", {
    ...
    var Es = function () {
        ...
        Ds = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.rootElRef = Ar(), t.slatElRefs = new Oi, t
            }
            return n(t, e), t.prototype.render = function () {
                var e = this.props,
                    t = this.context;
                ...
                var e, t = this.context,
                    n = this.props;
                n.onCoords && null !== n.clientWidth && this.rootElRef.current.offsetHeight && n.onCoords(new Es(new Mr(this.rootElRef.current, (e = this.slatElRefs.currentMap, n.slatMetas.map((function (t) {
                    return e[t.key]
    ...
    function Ts(e) {
        ...
        if (null == e.forwardPressure) {
            for (t = 0; t < r.length; t += 1) Ts(n = r[t]), o = Math.max(o, 1 + n.forwardPressure);
            e.forwardPressure = o
        }
    }
    ...
    function ks(e, t, n, r) {
        ...
        if (null == e.forwardCoord)
            for (i.length ? (function (e, t) {
                ...
                }(i, r), ks(i[0], t + 1, n, r), e.forwardCoord = i[0].backwardCoord) : e.forwardCoord = 1, e.backwardCoord = e.forwardCoord - (e.forwardCoord - n) / (t + 1), o = 0; o < i.length; o += 1) ks(i[o], 0, e.forwardCoord, r)
    }
    ...
    var xs = bt({
        ...
        _s = function (e) {
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                return this.props.isCondensed && e.push("fc-timegrid-event-condensed"), Hr(Ji, r({}, this.props, {
    ...
    li.timeGridEventCondensedHeight = 30;
    var Ps = function (e) {
            function t() {
                return null !== e && e.apply(this, arguments) || this
            }
            return n(t, e), t.prototype.render = function () {
                ...
                return Hr(ra, {
                    ...
                    return Hr("td", r({
                        ...
                        className: "fc-timegrid-now-indicator-container"
                    }, e.renderNowIndicator(t.nowIndicatorSegs)), Hr(Is, {
                        date: t.date,
                        dateProfile: t.dateProfile,
                        todayRange: t.todayRange,
                        extraHookProps: t.extraHookProps
                ...
                var t = this.props;
                return (e = vn(e, this.context.options.eventOrder)).map((function (e) {
                    return Hr("div", {
                ...
                return (e = function (e, t, n, r, o) {
                    return ws(e, t, n, r),
                        function (e, t) {
                            for (var n = 0, r = e; n < r.length; n++)(c = r[n]).level = null, c.forwardCoord = null, c.backwardCoord = null, c.forwardPressure = null;
                            var o, i = function (e) {
                                var t, n, r, o = [];
                                for (t = 0; t < e.length; t += 1) {
                                    for (n = e[t], r = 0; r < o.length && Rs(n, o[r]).length; r += 1);
                            ...
                            if (function (e) {
                                    ...
                                    for (t = 0; t < e.length; t += 1)
                                        for (n = e[t], r = 0; r < n.length; r += 1)
                                            for ((o = n[r]).forwardSegs = [], i = t + 1; i < e.length; i += 1) Rs(o, e[i], o.forwardSegs)
                                }(i), o = i[0]) {
                                for (var a = 0, s = o; a < s.length; a++) Ts(c = s[a]);
                    ...
                    return Hr("div", {
                        ...
                        isCondensed: e.bottom - e.top < li.timeGridEventCondensedHeight
                ...
                ws(e, i.date, i.slatCoords, o.options.eventMinHeight);
                var a = e.map((function (e) {
                    return Hr("div", {
                        ...
                        seg: e
                    }, Dn(e, i.todayRange, i.nowDate))) : oa(t))
                }));
                return Hr(Ur, null, a)
        ...
        Ns = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.splitFgEventSegs = st(bs), t.splitBgEventSegs = st(bs), t.splitBusinessHourSegs = st(bs), t.splitNowIndicatorSegs = st(bs), t.splitDateSelectionSegs = st(bs), t.splitEventDrag = st(Cs), t.splitEventResize = st(Cs), t.rootElRef = Ar(), t.cellElRefs = new Oi, t
            }
            return n(t, e), t.prototype.render = function () {
                var e = this,
                    t = this.props,
        ...
        Hs = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.processSlotOptions = st(Os), t.state = {
                    slatCoords: null
    ...
    var As = function (e) {
        ...
        Us = function (e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildDayRanges = st(Ls), t.slicer = new As, t.timeColsRef = Ar(), t.handleRootEl = function (e) {
                    e ? t.context.registerInteractiveComponent(t, {
                        el: e
                    }) : t.context.unregisterInteractiveComponent(t)
                }, t
    ...
    function Vs(e, t, n, r, o) {
        for (var i = new Date(0), a = e, s = Xe(0), l = n || function (e) {
                var t, n, r;
                for (t = Ws.length - 1; t >= 0; t -= 1)
                    if (null !== (r = tt(n = Xe(Ws[t]), e)) && r > 1) return n;
                return e
            }(r), u = []; et(a) < et(t);) {
            var c = o.add(i, a),
                d = null !== tt(s, l);
    ...
    var Fs = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildTimeColsModel = st(zs), t.buildSlatMetas = st(Vs), t
        }
        return n(t, e), t.prototype.render = function () {
            var e = this,
                t = this.context,
                    ...
                    return Hr("tr", {
                        ...
                        if (!1 !== r.displayEventTime) {
                            var o = e.eventRange.def,
                                ...
                                a = !1,
                                s = void 0;
                            if (o.allDay ? a = !0 : Qt(e.eventRange.range) ? e.isStart ? s = Sn(e, t, n, null, null, i.range.start, e.end) : e.isEnd ? s = Sn(e, t, n, null, null, e.start, i.range.end) : a = !0 : s = Sn(e, t, n), a) {
                                var l = {
    ...
    var Ks = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeDateVars = st($s), t.eventStoreToSegs = st(t._eventStoreToSegs), t.setRootEl = function (e) {
                e ? t.context.registerInteractiveComponent(t, {
                    el: e
                }) : t.context.unregisterInteractiveComponent(t)
            }, t
            ...
            return Hr(Ri, {
                ...
                for (var s = [], l = 0; l < a.length; l += 1) {
                    ...
                    if (u) {
                        ...
                        for (var d = 0, p = u = vn(u, i.eventOrder); d < p.length; d++) {
                            var f = p[d];
                            s.push(Hr(Ys, r({
    ...
    }, tl.prototype.baseIconClass = "fa", tl.prototype.iconClasses = {
        close: "fa-times",
        prev: "fa-chevron-left",
        next: "fa-chevron-right",
        prevYear: "fa-angle-double-left",
        nextYear: "fa-angle-double-right"
    }, tl.prototype.rtlIconClasses = {
        prev: "fa-chevron-right",
        next: "fa-chevron-left",
        prevYear: "fa-angle-double-right",
        nextYear: "fa-angle-double-left"
    }, tl.prototype.iconOverrideOption = "bootstrapFontAwesome", tl.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome", tl.prototype.iconOverridePrefix = "fa-";
    var nl = io({
            themeClasses: {
                bootstrap: tl
            }
                ...
                fetch: function (e, t, n) {
                    ...
                    if (l) {
                        var u = function (e) {
                            ...
                            p = function (e, t, n, o) {
                                var i, a, s;
                                return o.canComputeOffset ? (a = o.formatIso(e.start), s = o.formatIso(e.end)) : (a = me(e.start, -1).toISOString(), s = me(e.end, 1).toISOString()), i = r(r({}, n || {}), {
                                    key: t,
                                    timeMin: a,
                                    timeMax: s,
                                    singleEvents: !0,
    ...
    return Wo.push(Ua, cs, Bs, el, nl, rl), e.BASE_OPTION_DEFAULTS = wt, e.BASE_OPTION_REFINERS = Ct, e.BaseComponent = Gr, e.BgEvent = ia, e.BootstrapTheme = tl, e.Calendar = ua, e.CalendarApi = Fn, e.CalendarContent = gi, e.CalendarDataManager = Go, e.CalendarDataProvider = ni, e.CalendarRoot = Ei, e.Component = Nr, e.ContentHook = co, e.CustomContentRenderContext = uo, e.DateComponent = oo, e.DateEnv = Xn, e.DateProfileGenerator = bo, e.DayCellContent = ta, e.DayCellRoot = ra, e.DayGridView = ls, e.DayHeader = ki, e.DaySeriesModel = xi, e.DayTable = ss, e.DayTableModel = _i, e.DayTableSlicer = as, e.DayTimeCols = Us, e.DayTimeColsSlicer = As, e.DayTimeColsView = Fs, e.DelayedRunner = zo, e.Draggable = Ha, e.ElementDragging = si, e.ElementScrollController = _r, e.Emitter = kr, e.EventApi = zn, e.EventRoot = Ki, e.EventSourceApi = V, e.FeaturefulElementDragging = Da, e.Fragment = Ur, e.Interaction = ri, e.ListView = Ks, e.MountHook = fo, e.NamedTimeZoneImpl = function (e) {
    ...
    }, e.createEventInstance = Ne, e.createEventUi = Ft, e.createFormatter = bt, e.createPlugin = io, e.createRef = Ar, e.diffDates = en, e.diffDayAndTime = De, e.diffDays = Se, e.diffPoints = ur, e.diffWeeks = Ee, e.diffWholeDays = Ce, e.diffWholeWeeks = be, e.disableCursor = te, e.elementClosest = z, e.elementMatches = B, e.enableCursor = ne, e.eventTupleToStore = Ht, e.filterEventStoreDefs = Ut, e.filterHash = Ae, e.findDirectChildren = function (e, t) {
        for (var n = e instanceof HTMLElement ? [e] : e, r = [], o = 0; o < n.length; o += 1)
        ...
        return r
    }, e.findElements = j, e.flexibleCompare = ce, e.flushToDom = Wr, e.formatDate = function (e, t) {
        void 0 === t && (t = {});
        var n = tr(t),
            r = bt(t),
    ...
    }, e.getAllowYScrolling = Li, e.getCanVGrowWithinCell = cr, e.getClippingParents = Rr, e.getDateMeta = hr, e.getDayClassNames = vr, e.getDefaultEventEnd = Pn, e.getElSeg = pn, e.getEventClassNames = bn, e.getIsRtlScrollbarOnLeft = Er, e.getRectCenter = lr, e.getRelevantEvents = Ot, e.getScrollGridClassNames = ji, e.getScrollbarWidths = Sr, e.getSectionClassNames = Gi, e.getSectionHasLiquidHeight = Ui, e.getSegMeta = Dn, e.getSlotClassNames = function (e, t) {
    ...
    }, e.getStickyFooterScrollbar = Zi, e.getStickyHeaderDates = Yi, e.getUnequalProps = Fe, e.globalLocales = Kn, e.globalPlugins = Wo, e.greatestDurationDenominator = nt, e.guid = ee, e.hasBgRendering = cn, e.hasShrinkWidth = Bi, e.identity = Pt, e.interactionSettingsStore = ai, e.interactionSettingsToStore = ii, e.intersectRanges = rn, e.intersectRects = ar, e.isArraysEqual = at, e.isColPropsEqual = Vi, e.isDateSpansEqual = Tn, e.isInt = fe, e.isInteractionValid = Jr, e.isMultiDayRange = Qt, e.isPropsEqual = Ve, e.isPropsValid = Qr, e.isValidDate = Ie, e.listenBySelector = K, e.mapHash = Ue, e.memoize = st, e.memoizeArraylike = function (e, t, n) {
        var r = this,
            o = [],
            i = [];
        return function (a) {
    ...
    }, e.memoizeObjArg = lt, e.mergeEventStores = At, e.multiplyDuration = $e, e.padStart = de, e.parseBusinessHours = or, e.parseClassNames = Lt, e.parseDragMeta = ci, e.parseEventDef = Kt, e.parseFieldSpecs = se, e.parseMarker = Zn, e.pointInsideRect = ir, e.preventContextMenu = ie, e.preventDefault = Z, e.preventSelection = re, e.rangeContainsMarker = ln, e.rangeContainsRange = sn, e.rangesEqual = on, e.rangesIntersect = an, e.refineEventDef = Zt, e.refineProps = It, e.removeElement = F, e.removeExact = function (e, t) {
        for (var n = 0, r = 0; r < e.length;) e[r] === t ? (e.splice(r, 1), n += 1) : r += 1;
        return n
    }, e.render = Or, e.renderChunkContent = Wi, e.renderFill = oa, e.renderMicroColGroup = Fi, e.renderScrollShim = qi, e.requestJson = Ao, e.sanitizeShrinkWidth = zi, e.setElSeg = dn, e.setRef = Zr, e.sliceEventStore = un, e.sliceEvents = function (e, t) {
        return un(e.eventStore, e.eventUiBases, e.dateProfile.activeRange, t ? e.nextDayThreshold : null).fg
    }, e.sortEventSegs = vn, e.startOfDay = we, e.translateRect = function (e, t, n) {
        return {
            left: e.left + t,
            right: e.right + t,
            top: e.top + n,
    ...
    }, e.triggerDateSelect = _n, e.unmountComponentAtNode = Vr, e.unpromisify = Tr, e.version = "5.5.1", e.whenTransitionDone = $, e.wholeDivideDurations = tt, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});
