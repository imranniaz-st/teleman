                ...
                <div class="grid grid-cols-1 gap-6 lg:p-10 xl:grid-cols-0 lg:bg-base-200 rounded-box">
                    ...
                    <div class="card col-span-1 row-span-3 shadow-lg xl:col-span-2 bg-base-100">
                        <div class="card-body">
                            ...
                            <p class="my-4 font-bold">{{ translate('Checking files & folder permissions. We ran diagnosis on your
                            ...
                            <div class="justify-end space-x-2 card-actions">
                                ...
                                $permission['htaccess'] && 
                                versionOfPhp() >= 7.40)
                                <a href="{{ route('create') }}" class="btn btn-secondary">{{ translate('Go to database setup') }}</a>
                                @else
                                <a href="javascript:;" 
                                class="btn btn-danger">
                                {{ translate('Permissions Error. Please check folder or file permissions') }}
                                </a>
                            @endif
