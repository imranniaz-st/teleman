                        ...
                        <div class="nk-block nk-block-middle nk-auth-body">
                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h5 class="nk-block-title">{{ translate('Forgot Password') }}</h5>
                                    <div class="nk-block-des">
                                        <p>{{ translate('Enter your email address to reset your password.') }}</p>
                                    </div>
                                </div>
                            </div>
                            <form action="{{ route('email.generate.new.password') }}" method="GET">
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <label class="form-label" for="default-01">{{ translate('Enter Email Address') }}</label>
                                    </div>
                                    <input type="email" class="form-control form-control-lg" name="email" id="default-01" placeholder="Enter Email Address">
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-lg btn-secondary btn-block">{{ translate('Submit') }}</button>
                                </div>
                            </form>
