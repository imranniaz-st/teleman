                     ...
                     <div class="nk-wg1-block">
                         <div class="nk-wg1-img">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                 <rect x="5" y="7" width="60" height="56" rx="7" ry="7" fill="#e3e7fe" stroke="#6576ff"
                                 ...
                                 <rect x="15" y="17" width="60" height="56" rx="7" ry="7" fill="#fff" stroke="#6576ff"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                 ...
                                 <rect x="22" y="39" width="20" height="20" rx="2" ry="2" fill="none" stroke="#6576ff"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                 <circle cx="32" cy="45.81" r="2" fill="none" stroke="#6576ff" stroke-linecap="round"
                                     stroke-linejoin="round" stroke-width="2" />
                                 <path d="M29,54.31a3,3,0,0,1,6,0" fill="none" stroke="#6576ff" stroke-linecap="round"
                                     stroke-linejoin="round" stroke-width="2" />
                         ...
                         <div class="nk-wg1-text">
                             <h5 class="title">{{ translate('Personal Info') }}</h5>
                             <p>{{ translate('See your profile data and manage your Account to choose what is saved in our system') }}.</p>
                         </div>
                     </div>
                     <div class="nk-wg1-action">
                         <a href="{{ route('dashboard.profile.information') }}" class="link"><span>{{ translate('Manage Your Account') }}</span> <em
                         ...
                         <div class="nk-wg1-img">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                 ...
                                 <path
                                     ...
                                     fill="#e3e7fe" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round"
                                     stroke-width="2" />
                                 <circle cx="71.5" cy="21" r="13.5" fill="#fff" stroke="#6576ff" stroke-linecap="round"
                                     stroke-linejoin="round" stroke-width="2" />
                                 ...
                                 <path
                                     ...
                                     stroke-width="2" />
                                 <polyline points="77.75 16.61 77.75 20.61 73.75 20.61" fill="none" stroke="#6576ff"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" /></svg>
                         </div>
                         <div class="nk-wg1-text">
                             <h5 class="title">{{ translate('My Subscription') }}</h5>
                             <p>{{ translate('You have full control to manage your own account and keep account fully secure') }}.</p>
                         </div>
                     </div>
                     <div class="nk-wg1-action">
                         <a href="{{ route('dashboard.profile.billing.subscription') }}" class="link"><span>{{ translate('View Subscription') }}</span> <em
                                 class="icon ni ni-chevron-right"></em></a>
                     </div>
                 </div>
             </div>
                         ...
                         <div class="nk-wg1-img">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                 <path
                                     ...
                                     fill="#eff1ff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round"
                                     stroke-width="2" />
                                 <polyline points="73 12.18 69.83 26.66 85.37 30.08" fill="#eff1ff" stroke="#6576ff"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                 <path
                                     ...
                                     fill="#e3e7fe" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round"
                                     stroke-width="2" />
                                 <polyline points="36.7 8.22 41.05 22.53 56.33 17.96" fill="#e3e7fe" stroke="#6576ff"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                 ...
                                 <line x1="35" y1="69" x2="51" y2="69" fill="none" stroke="#c4cefe"
                                     ...
                                     transform="translate(34.54 43.18) scale(0.99 1)" font-size="9.31" fill="#6576ff"
                                     font-family="Nunito-Black, Nunito Black">$</text></svg>
                         </div>
                         <div class="nk-wg1-text">
                             <h5 class="title">{{ translate('Billing History') }}</h5>
                             <p>{{ translate('Check out all your payment history. You can also download or print your invoice') }}.</p>
                         </div>
                     </div>
                     <div class="nk-wg1-action">
                         <a href="{{ route('dashboard.profile.billing.history') }}" class="link"><span>{{ translate('Payment History') }}</span> <em
                                 class="icon ni ni-chevron-right"></em></a>
                     </div>
                 </div>
             </div>
             ...
             <div class="card card-bordered card-full">
                 <div class="nk-wg1">
                     <div class="nk-wg1-block">
                         <div class="nk-wg1-img">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
                                 ...
                                 <path
                                     ...
                                     fill="#eff1ff" stroke="#6576ff" stroke-linecap="round" stroke-linejoin="round"
                                     stroke-width="2" />
                                 <rect x="15" y="15" width="54" height="70" rx="6" ry="6" fill="#fff" stroke="#6576ff"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                 ...
                                 <circle cx="38" cy="66" r="0.5" fill="#c4cefe" stroke="#c4cefe"
                                     stroke-miterlimit="10" />
                                 <path d="M46,40l-15-.3V40A15,15,0,1,0,46,25h-.36Z" fill="#e3e7fe" stroke="#6576ff"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                         ...
                         <div class="nk-wg1-text">
                             <h5 class="title">{{ translate('Account Reports') }}</h5>
                             <p>{{ translate('Check your reports of uses and manage your packages or subscriptions that you have') }}.</p>
                         </div>
                     </div>
                     <div class="nk-wg1-action">
                         <a href="{{ route('dashboard.profile.account.report') }}" class="link"><span>{{ translate('View Report') }}</span>
