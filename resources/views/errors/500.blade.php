...
<head>
    ...
    <!-- Page Title  -->
    <title>{{ translate('500 | SOMETHING WENT WRONG') }}</title>
    <!-- StyleSheets  -->
                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            <img class="nk-error-gfx" src="{{ asset('backend/images/gfx/error-500.svg') }}" alt="">
                            <div class="wide-xs mx-auto">
                                <h3 class="nk-error-title">{{ translate('Oops! Something went wrong') }}.</h3>
