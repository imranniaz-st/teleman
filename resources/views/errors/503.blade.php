...
<head>
    ...
    <!-- Page Title  -->
    <title>{{ translate('503 | SERVICE UNAVAILABLE') }}</title>
    <!-- StyleSheets  -->
                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            <img class="nk-error-gfx" src="{{ asset('backend/images/gfx/error-503.svg') }}" alt="">
                            <div class="wide-xs mx-auto">
                                <h3 class="nk-error-title">{{ translate('SERVICE UNAVAILABLE') }}</h3>
                                <p class="nk-error-text">{{ translate('You may have mistyped the address or the page may have moved') }}.</p>
